...
export const translations: Record<Language, Translations> = {
  ar: {
    ...
    levels: {
      ...
      level7Title: 'السوق والاستراتيجية',
      ...
      level1Objective: 'تحديد تفاصيل المشروع الأساسية وهيكل الملكية',
      level1Deliverable: 'معلومات المشروع والملاك مع توزيع النسب',
      ...
      level7Objective: 'تحليل المنافسين وتحديد المنتجات وإجراء تحليل SWOT متطور',
      level7Deliverable: 'تحليل المنافسين + المنتجات + تحليل SWOT (حتى 9 نقاط لكل قسم)',
  ...
  en: {
    ...
    levels: {
      ...
      level1Title: 'Identity & Ownership',
      ...
      level1Objective: 'Define core project details and ownership structure',
      level1Deliverable: 'Project and owner information with share distribution',
      ...
      level7Objective: 'Analyze competitors, define products, and conduct an advanced SWOT analysis',
      level7Deliverable: 'Competitor analysis + products + SWOT analysis (up to 9 points per section)',
