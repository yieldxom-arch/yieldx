...
export const translations: Record<Language, Translations> = {
  ar: {
    ...
    levels: {
      ...
      level3Deliverable: 'قائمة الأصول مع التكاليف والكميات',
      level4Objective: 'تخطيط احتياجات الموظفين والالتزام بنسب التعمين',
      level4Deliverable: 'خطة التوظيف مع الرواتب ونسب التعمين',
      level5Objective: 'تحديد الاحتياجات التشغيلية اليومية والتراخيص',
      level5Deliverable: 'قائمة المتطلبات التشغيلية مع التكاليف الشهرية',
      level6Objective: 'دراسة السوق المستهدف وحجمه وفرص النمو',
      level6Deliverable: 'تقرير تحليل السوق مع الإحصائيات',
      level7Objective: 'إعداد التوقعات المالية وحساب نقطة التعادل',
      level7Deliverable: 'خطة مالية مع جداول التدفقات النقدية',
  ...
  en: {
    ...
    levels: {
      ...
      level3Deliverable: 'List of assets with costs and quantities',
      level4Objective: 'Plan staff needs and adhere to employment ratios',
      level4Deliverable: 'Staffing plan with salaries and employment ratios',
      level5Objective: 'Identify daily operational requirements and licenses',
      level5Deliverable: 'List of operational requirements with monthly costs',
      level6Objective: 'Study the target market, its size, and growth opportunities',
      level6Deliverable: 'Market analysis report with statistics',
      level7Objective: 'Set financial projections and calculate the break-even point',
      level7Deliverable: 'Financial plan with cash flow tables',
