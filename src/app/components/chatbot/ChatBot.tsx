...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'المستويات الثمانية (0-7) وفق معايير الجدوى العُمانية:\n0️⃣ اختيار نوع المشروع - زراعي/صناعي/تجاري/خدمي\n1️⃣ الهوية والملكية - معلومات المشروع والملاك\n2️⃣ الإطار القانوني والتنظيمي - التراخيص والمتطلبات\n3️⃣ الموارد المادية والفنية - الموقع والمعدات\n4️⃣ الموارد البشرية والتنظيمية - التوظيف والتعمين\n5️⃣ السوق والاستراتيجية - تحليل السوق وSWOT\n6️⃣ التمويل والمؤشرات المالية - الخطة المالية وKPIs\n7️⃣ النموذج الشامل والتنفيذ - BMC ورؤية 2040',
  ...
  {
    question: 'ما هو تحليل SWOT المعزز في المستوى 5؟',
    answer: 'المستوى 5 يتضمن تحليل SWOT متقدماً:\n💪 نقاط القوة\n⚠️ نقاط الضعف\n🚀 الفرص\n🎯 التهديدات\n\nبالإضافة إلى:\n• مقارنة السيناريوهات المتعددة\n• معايير أداء القطاع\n• مؤشرات KPI مخصصة لنوع مشروعك',
    keywords: ['swot', 'تحليل', 'نقاط القوة', 'نقاط الضعف', 'فرص', 'تهديدات', 'مستوى 5', 'level 5', 'السوق', 'استراتيجية']
  },
  {
    question: 'ما هو Business Model Canvas في المستوى 7؟',
    answer: 'المستوى 7 يتضمن نموذج الأعمال الشامل (BMC) بـ 9 مكونات:\n1. شرائح العملاء\n2. القيمة المقدمة\n3. قنوات التوزيع\n4. علاقات العملاء\n5. مصادر الإيراد\n6. الموارد الرئيسية\n7. الأنشطة الرئيسية\n8. الشراكات الرئيسية\n9. هيكل التكاليف\n\nكما يتضمن خطة التنفيذ وربط المشروع بأهداف رؤية عُمان 2040.',
    keywords: ['bmc', 'business model canvas', 'نموذج الأعمال', 'مستوى 7', 'level 7', 'تنفيذ', 'رؤية 2040', 'عمان 2040', 'canvas']
  }
];
